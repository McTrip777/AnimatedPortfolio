  ...
  return (
    <div className="">
        <svg className="svg-icon__arrow--right arrow position-fixed" onClick={navEffect} viewBox="0 0 7 12"  preserveAspectRatio="MinYMin" xmlns="http://www.w3.org/2000/svg">
            <path fill="#84a98c" d="M6.893 5.967c0-.268-.107-.524-.295-.713L1.724.37C1.33-.024.692-.024.3.37c-.394.394-.394 1.033 0 1.427l4.162 4.17L.3 10.137c-.394.394-.394 1.033 0 1.427.392.394 1.03.394 1.424 0L6.598 6.68c.188-.19.295-.445.295-.713z"/>
        </svg>
      <Nav
        defaultActiveKey="/home"
        className="cNavContainer h2 d-flex flex-column"
      >
        <Nav.Link eventKey="link-1" className="hoverStyles">
          <h2>Home</h2>
        </Nav.Link>
        <Nav.Link eventKey="link-2" className="hoverStyles">
          <h2>About</h2>
        </Nav.Link>
        <Nav.Link eventKey="link-3" className="hoverStyles">
          <h2>Projects</h2>
        </Nav.Link>
        <Nav.Link eventKey="link-4" className="hoverStyles">
          <h2>Contact</h2>
        </Nav.Link>
